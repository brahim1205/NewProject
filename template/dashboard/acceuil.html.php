        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-2xl font-bold text-gray-900"><?= $stats['demandes_annulation'] ?></h3>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-2xl font-bold text-gray-900"><?= $stats['demandes_validees'] ?></h3>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-2xl font-bold text-gray-900"><?= $stats['demandes_rejetees'] ?></h3>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <div class="divide-y divide-gray-100">
                    <?php if (!empty($demandes_annulation)): ?>
                        <?php foreach ($demandes_annulation as $demande): ?>
                                    ...
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <div>
                                            <h3 class="font-semibold text-gray-900">
                                                <?= htmlspecialchars($demande['client_nom']) ?> <?= htmlspecialchars($demande['client_prenom']) ?>
                                            </h3>
                                            <p class="text-sm text-gray-500">
                                                Transaction: <?= number_format($demande['montant'], 0, ',', ' ') ?> FCFA
                                            </p>
                                            <p class="text-xs text-gray-400">
                                                Demande du <?= date('d/m/Y à H:i', strtotime($demande['date_demande'])) ?>
                                            </p>
                                        </div>
                                    </div>
